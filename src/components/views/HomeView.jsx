      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-gray-400 font-medium">Lvl {level} <span className="text-gray-600">({currentLevelXp}/{xpNextLevel} XP)</span></span>
          </div>
        </div>

        {/* Velocity Score */}
        <div className="flex items-center gap-3 bg-surface-800/30 px-5 py-2.5 rounded-2xl border border-white/5 shadow-lg">
