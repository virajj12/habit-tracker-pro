    ...
    <div className="w-full flex flex-col h-full">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-3 self-end sm:self-auto">
          {/* Tokens */}
          <div className="flex items-center gap-1.5 px-3 py-1.5 bg-amber-500/10 border border-amber-500/20 rounded-lg text-amber-400 font-medium text-sm shrink-0" title="Streak Freeze Tokens">
          ...
          <div className="relative shrink-0">
            <select 
              ...
              className="appearance-none bg-surface-900/50 border border-white/10 text-sm rounded-lg pl-3 pr-8 py-2 focus:outline-none focus:border-primary transition-colors cursor-pointer text-gray-300 hover:text-white"
            >
      ...
      <div className="flex-grow w-full overflow-x-auto overflow-y-hidden pb-2 custom-scrollbar">
        <div className="flex gap-1.5 bg-surface-900/30 p-4 md:p-6 rounded-2xl border border-white/5 w-max mx-auto shadow-inner">
